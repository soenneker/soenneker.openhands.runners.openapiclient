...
using Soenneker.OpenHands.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.OpenHands.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["OpenHands:ClientGenerationUrl"] ?? "https://app.all-hands.dev/openapi.json";
        ...
        if (filePath == null)
            throw new InvalidOperationException("OpenHands OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "OpenHandsOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
